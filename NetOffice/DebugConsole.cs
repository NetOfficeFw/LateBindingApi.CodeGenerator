...
namespace NetOffice
{
    ...
    public static class DebugConsole
    {
        ...
        public static void WriteLine(string message, params object[] args)
        {
            ...
            InternalSendNamedPipeMessage(output);
        }
        ...
        public static bool SendNamedPipeMessage(string message)
        {
            try
            {
                lock (_sharedLock)
                {
                    if (null == Pipe)
                        Pipe = new PipeClient();
                    return Pipe.SendConsoleMessage(message);
                }
            }
        ...
        /// <param name="message">he given message as any</param>
        /// <returns>true if send</returns>
        public static bool SendNamedPipeChannelMessage(string channel, string message)
        {
            try
            {
                lock (_sharedLock)
        ...
        /// <param name="message">the given message as any</param>
        /// <returns>true if send</returns>
        internal static bool InternalSendNamedPipeMessage(string message)
        {
            try
            {
        ...
        /// <param name="message">the given message as any</param>
        /// <returns>true if send</returns>
        internal static bool InternalSendNamedPipeChannelMessage(string channel, string message)
        {
            try
            {
                if (!EnableSharedOutput)
