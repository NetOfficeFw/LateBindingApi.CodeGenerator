    ...
    internal static class CoClassApi
    {
        ...
        private static string GetDelegateSignatur(string className, XElement methodNode)
        {
            ...
            foreach (XElement itemParam in methodNode.Element("Parameters").Elements("Parameter"))
            {
                ...
                {
                    par = isRef + itemParam.Attribute("Name").Value + " As " + "COMObject";
                }
                else
                {
        ...
        private static string GetEvents(XElement projectNode, XElement faceNode)
        {
            ...
            foreach (var itemNode in doc.Element("Methods").Elements("Method"))
            {
                ...
                line += "\t\tPrivate Event _" + itemNode.Attribute("Name").Value + "Event" +                   
                   " As " +
                    faceNode.Attribute("Name").Value + "_" + itemNode.Attribute("Name").Value + "EventHandler" +
                    "\r\n\r\n";

                line += "\t\t''' <summary>\r\n" + "\t\t''' SupportByLibrary " + projectNode.Attribute("Name").Value + " " + versionAttributeString.Replace(",", " ").Replace("\"", "") +
                    "\r\n" + "\t\t''' </summary>\r\n";  

                line += "\t\t<SupportByLibrary(" + "\"" + projectNode.Attribute("Name").Value + "\"" + ", " + versionAttributeString.Replace("\"", "") + ")> _\r\n";

                string field = itemNode.Attribute("Name").Value + "Event";

                line += "\t\tPublic Custom Event "+ itemNode.Attribute("Name").Value + "Event" + " As " +
                    faceNode.Attribute("Name").Value + "_" + itemNode.Attribute("Name").Value + "EventHandler\r\n\r\n" +
                    "\t\t\tAddHandler (ByVal value As " + faceNode.Attribute("Name").Value + "_" + itemNode.Attribute("Name").Value + "EventHandler" + ")\r\n\t\t\t\r\n" + "\t\t\t\tCreateEventBridge()\r\n" + "\t\t\t\t" +
                    "AddHandler AddressOf Me._" + field + ", value" +
                    "\r\n" + "\t\t\tEnd AddHandler\r\n" + "\t\t\tRemoveHandler(ByVal value As " + faceNode.Attribute("Name").Value + "_" + itemNode.Attribute("Name").Value + "EventHandler" + ")\r\n" +
                    "\t\t\t\r\n\t\t\t\t" +
                    "RemoveHandler AddressOf Me._" + field + ", value" +
                    "\r\n\t\t\tEnd RemoveHandler\r\n" +
                    "\t\tEnd Event\r\n\r\n";
            }
